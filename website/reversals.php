...
<div class = "newwrap small_bottom_margin">
	<div class="section n1 <?php echo $showClass; ?>">
		<div id="maintitle">
			Watchlist <div id="smallText">Reversals</div>
		</div >
			...
			<table id="watchTable" class="watchtable" cellspacing="0" cellpadding ="0" border="0">
				<thead>
					<tr class="table_head">
						...
						<th class="bottom"><span class="hastooltip" title="Entry Price">Entry Price</span><div class="none">The entry price specifies the ideal purchase price of this stock.</div></th>
						<th class="bottom"><span class="hastooltip" title="Percent From Zone">% from Entry</span><div class="none">The percentage difference from the last sell price and the entry price.</div></th>
						<th class="bottom"><span class="hastooltip" title="First Target">Target 1</span><div class="none">The First BioBounce Target. This is the first sell point after this stock drops to the entry price.</div></th>
						<th></th>
					</tr>
				</thead>
				<tbody>
...
if ($showData){
	...
	foreach($watchlist as $watch){
		...
		echo '
			...
			<td class="zonecolumn"><div class="'. $highlights[W_ENTRY_ZONE] .'"><span class="topzone">' . number_format($watch['watchlist_top'], 2) . '</span></div></td>
			...
			<table id="holdingsTable" class="holdingstable" cellspacing="0" cellpadding ="0" border="0">
				<thead>
					<tr class="table_head">
						...
						<th class="bottom lowpriority"> <span class="hastooltip" title="Entry Date">Entry Date</span><div class="none">The date that this stock fell below the entry price.</div></th>
						...
						<th class="bottom lowpriority"> <span class="hastooltip" title="Entry Price">Entry Price</span><div class="none">The price when this stock was purchased.</div> </th>
